...
def radio_buttons_entrada(window, titulo_value, tipo_transacao, fluxo, e2): 
...
def radio_buttons_saida(window, titulo_value, tipo_transacao, fluxo, e2): 
...
def radio_buttons_tipo_transacao(window, titulo_value, tipo_transacao, fluxo, e2): 
