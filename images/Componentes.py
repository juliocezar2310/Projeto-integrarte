...
def radio_buttons_saida(window, titulo_value, e2): 
    ...
    tipo_saida_c_agua.place(x=150,y=88)
    ...
    tipo_saida_c_internet.place(x=150,y=68)
    ...
    tipo_saida_c_luz.place(x=150,y=130)
